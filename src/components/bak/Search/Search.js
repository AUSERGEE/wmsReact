...
export default class extends Component {
    ...
    keyUp(e) {   //xf:按键抬起时：清除按钮显示，如果是回车键，开始搜索
    ...
    handleSearch() {  //xf:搜索值去除空格，跳转到结果页面并传参，存储数据
    ...
    setHistory(data) { //xf:累加到state搜索记录，重新存localstore的搜索记录
    ...
    clearHistory(text) { //xf:查找删除内容的位置，并从数组中减去，重新存state和localstore
